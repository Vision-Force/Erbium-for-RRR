...
struct FConfiguration
{
    ...
    static inline auto bDelMarCallHandleMatchStarted = false;
    static inline auto bDelMarSkipClientLoadWait = false;
    static inline auto bDelMarPushStateMachine = false;
    ...
    static inline auto bDelMarObservePlayerInput = false;
    ...
    static inline auto bDelMarSendVerseURI = true;
